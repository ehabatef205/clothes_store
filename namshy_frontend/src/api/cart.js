...
export const add_cart = async (product_id, quantity,color,size, token) => {
    await axios.post(`${proxy}`, { product_id: product_id, quantity: quantity,color:color,size:size }, { headers: { authorization: token } })
}
