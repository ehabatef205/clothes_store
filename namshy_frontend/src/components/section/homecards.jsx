...
export default function Homecards(
  ...
  useEffect(() => {
    const getProducts = async () => {
      ...
      } else if (type_name === "First visit products") {
        product.get_product_first_visit(category_id).then((e) => {
      ...
      } else if (type_name === "Hot sale") {
        await product.get_product_of_category(category_id).then((e) => {
